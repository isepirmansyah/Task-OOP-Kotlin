...
fun myProfile() {
    ...
    val firstName: String = "Isep"
    val lastName: String = "Irmansyah"
    val age: Int = 22
    ...
    println("Nama Depan : $firstName \n" +
            ...
            "Umur : $age Tahun \n" +
            "Status :${ if (status) " Single" else "No Single"}")
 ...
 */
fun totalMember(): Int {
    val mentor = arrayOf<String>("Kak Ayat", "Kak Reza", "Kak Megy")
...
fun main() {
     ...
     *
     */
    groupDetail("Group-04", groupMembers, "Morning")
